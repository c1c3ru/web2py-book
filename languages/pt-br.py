...
'Python': 'Python',
'Query:': 'Consulta:',
'Quick Examples': 'Exmplos rápidos',
'RAM': 'RAM',
...
'The Core': 'The Core',
'The output of the file is a dictionary that was rendered by the view %s': 'A saída do arquivo é um dicionario que foi renderizado pela view %s',
'The Views': 'The Views',
'This App': 'This App',
...
'You are successfully running web2py': 'Você está executando com sucesso o web2py',
'You are successfully running web2py.': 'Você está executando com sucesso o  web2py.',
'You can modify this application and adapt it to your needs': 'Você precisa modificar esta aplicação e adaptar-la a sua necessidade',
